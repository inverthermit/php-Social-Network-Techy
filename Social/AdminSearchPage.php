...
$users=$sql->getUsersByKeywords($key);
$posts=$sql->getPostsByKeywords($key);
$replies=$sql->getRepliesByKeywords($key);
...
<a href="AdminPRPage.php" class="item">
All Posts&Replies
</a>
<a class="active item">
Search Result of "<?php echo $_GET['keyword'];?>"
</a>
</div>
    <div class="column">
  ...
  foreach ($users as $u)
  {
  	...
  	echo "<td>".$u->name."</td>";
  	echo "<td>".$u->gender."</td>";
  	echo "<td>".$u->birthday."</td>";
    $file="avatar/".$u->Uid.".bmp";
          if(file_exists($file))
          {
          	echo "<td><a href='".$file."'>See Avatar.</a></td>";
          }
          else 
          {
          	echo "<td></td>";
  	...
  	echo "<td><a href='DeleteUserPage.php?Uid=".$u->Uid."'>Delete</a></td>";
  	echo "</tr>";
  }
  ?>
