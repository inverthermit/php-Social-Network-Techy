			...
			<div class="row">
				<div class="column">
					...
					<div class="ui large menu">
						<a href="Main.php" class="active item"> <i class="home icon"></i> Home
...
<div class="ui segment">
    <div class="column">
    <form class="ui form" action="PostPage.php" method="post" enctype="multipart/form-data">
              
            <textarea name="content"></textarea>
            <br><i class="huge purple photo icon"></i><input class="ui grey button" accept="image/*" type="file" name="file"/><i class="big smile icon"></i>
                <br/><br><input class="ui green massive rounded button"  type="submit" value="Post">
            </form>
        </div>
</div>
</div>
